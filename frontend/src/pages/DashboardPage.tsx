...
import { KhachHang, Item, QuoteData, generatePdf, downloadBlob, saveQuoteData } from "../api/client";
import "../App.css"; 

const EMPTY_KH: KhachHang = { ten: "", sdt: "", dia_chi: "" };
const EMPTY_ITEM: Item = { stt: 1, ten_hang: "", dvt: "Cái", so_luong: 1, don_gia: 0, vat: 0.08, ghi_chu: "" };
